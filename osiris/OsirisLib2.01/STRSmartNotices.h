...
class smResidualDisplacementFractionalLimit : public SmartNotice {

PERSISTENT_DECLARATION (smResidualDisplacementFractionalLimit)
...
class smWeakPrimaryInterchannelLink : public SmartNotice {

PERSISTENT_DECLARATION (smWeakPrimaryInterchannelLink)

public:
	smWeakPrimaryInterchannelLink ();
	smWeakPrimaryInterchannelLink (const smWeakPrimaryInterchannelLink& note);
	virtual ~smWeakPrimaryInterchannelLink ();
...
class smZeroPullupPrimaryInterchannelLink : public SmartNotice {

PERSISTENT_DECLARATION (smZeroPullupPrimaryInterchannelLink)
...
class smThreePointPeak : public SmartNotice {

PERSISTENT_DECLARATION (smThreePointPeak)
...
class smNoNegativeDataPreset : public SmartNotice {

PERSISTENT_DECLARATION (smNoNegativeDataPreset)

public:
	smNoNegativeDataPreset ();
	smNoNegativeDataPreset (const smNoNegativeDataPreset& note);
	virtual ~smNoNegativeDataPreset ();
...
class smTestPullupCorrectedHeightsPreset : public SmartNotice {

PERSISTENT_DECLARATION (smTestPullupCorrectedHeightsPreset)
...
class smRedundantPeak : public SmartNotice {

PERSISTENT_DECLARATION (smRedundantPeak)
