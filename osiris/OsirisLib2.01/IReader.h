 ...
 *
 * File Description:
 *          IReader - abstract interface class to provide a function
 *          to read a number of bytes from an offset
 */
#ifndef __I_READER_H__
#define __I_READER_H__
...
public:
  IReader() {}
  virtual ~IReader() {}
  virtual bool Read(void *pData, UINT32 nOffset, size_t nBytes) = 0;
};
