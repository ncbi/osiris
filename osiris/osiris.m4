...
#      /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk/usr
PLATFORM=`sh ../../osname`
WXHOME=`sh ../../findwx`
...
WXCXXR="-O2 -fno-strict-aliasing -fno-common -mmacosx-version-min=10.9 -D_WCHAR_H_CPLUSPLUS_98_CONFORMANCE_"
MACCXX=${MACMIN}
MACLD=${MACMIN}
