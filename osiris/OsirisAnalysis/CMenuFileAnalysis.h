...
* ===========================================================================
*
*  FileName: CMenuFileAnalysis.h
*  Author:   Douglas Hoffman
*  Purpose:  File menu for the menu bar for an analysis or table window.
*            i.e. .oer or .oar file
*
*/
#ifndef __C_MENU_FILE_TABLE_H__
#define __C_MENU_FILE_TABLE_H__
