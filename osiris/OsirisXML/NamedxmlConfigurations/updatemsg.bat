...
%COPY% %SRC% PPESI16_FSA/PPESI16_FSA_%DEST%
%COPY% %SRC% PPESI16_HID/PPESI16_HID_%DEST%
%COPY% %SRC% PPESI17_FSA/PPESI17_FSA_%DEST%
%COPY% %SRC% PPESI17_HID/PPESI17_HID_%DEST%
%COPY% %SRC% PPESX16_FSA/PPESX16_FSA_%DEST%
%COPY% %SRC% PPESX16_HID/PPESX16_HID_%DEST%
%COPY% %SRC% PPESX17_FSA/PPESX17_FSA_%DEST%
%COPY% %SRC% PPESX17_HID/PPESX17_HID_%DEST%
